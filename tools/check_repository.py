...
def main() -> int:
    ...
    required = (
        ...
        "skills/shotflow/references/advanced-workflow.md",
        ...
        "examples/forward-tests/frames/T01.png",
        "examples/forward-tests/frames/T02.png",
        "examples/forward-tests/frames/T03.png",
        "examples/forward-tests/frames/T04.png",
        "examples/forward-tests/frames/T05.png",
        "examples/forward-tests/frames/R01.png",
        "examples/forward-tests/frames/R02.png",
        "examples/simulated-user-tests/protocol-v040.json",
        "examples/simulated-user-tests/results-v040.json",
        "examples/simulated-user-tests/README.md",
        "examples/simulated-user-tests/outputs/S01.txt",
        "examples/simulated-user-tests/outputs/S02.txt",
        "examples/simulated-user-tests/outputs/S03.txt",
        "examples/simulated-user-tests/outputs/S04.txt",
        "examples/simulated-user-tests/outputs/S05.txt",
        "examples/simulated-user-tests/outputs/S06-post-fix.txt",
        "launch/demo-assets.json",
        "launch/live-demo-v041.json",
        "launch/demo-output-en.txt",
        "launch/demo-output-zh-public-main.txt",
        "launch/demo-output-zh-v041.txt",
